...
[Überblick](../../de/README.md) · [Architektur](architecture.md) · [Deployment](deployment.md) · [Sizing](sizing.md) · [Workflow](workflow.md) · [Toolchain](toolchain.md) · [Governance](governance.md) · [English](../en/toolchain.md)
...
| Post-Training: privates Fine-Tuning | NeMo AutoModel | lokales SFT und LoRA/PEFT | bevorzugte Trainingsschicht |
| Post-Training: Federation | NVIDIA FLARE | Policy-gesteuerte Adapteraggregation | optional nach lokalem Nachweis |
| Evaluation | NeMo Evaluator plus Compiler und Tests | reproduzierbare Qualitätsprüfung | verpflichtende kombinierte Evidenz |
| Post-Training: Preference/RL | NeMo RL | Preference- oder Verifier-gesteuertes Lernen | nur spätere Stufe |
